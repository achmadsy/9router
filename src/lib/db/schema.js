...
export const TABLES = {
  ...
  inferenceAccess: {
    ...
    indexes: [
      "CREATE INDEX IF NOT EXISTS idx_ia_timestamp ON inferenceAccess(timestamp DESC)",
      "CREATE INDEX IF NOT EXISTS idx_ia_key_ts ON inferenceAccess(apiKeyId, timestamp DESC)",
    ],
  },
  requestDetails: {
    columns: {
