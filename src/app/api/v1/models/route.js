...
import { filterCatalogByPolicy, loadCombosForPolicy } from "@/lib/apiKeys/policy.js";
...
export async function GET(request) {
  try {
    ...
    const filtered = filterCatalogByPolicy(keyCtx.keyRow, data, {
      combos: await loadCombosForPolicy(),
    });
