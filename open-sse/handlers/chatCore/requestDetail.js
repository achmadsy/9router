...
export function saveUsageStats({ provider, model, tokens, connectionId, apiKey, apiKeyId, apiKeyNameSnapshot, endpoint, label = "USAGE", silent = false }) {
  ...
  // Never persist the presented secret — only stable apiKeyId + name snapshot.
  saveRequestUsage({
    ...
    apiKeyNameSnapshot: apiKeyNameSnapshot || undefined,
