...
const USAGE_HANDLERS = {
  ...
  glm: (c) => getGlmUsage(c.apiKey, c.provider, c.proxyOptions, c.providerSpecificData),
  "glm-cn": (c) => getGlmUsage(c.apiKey, c.provider, c.proxyOptions, c.providerSpecificData),
