...
const USAGE_HANDLERS = {
  ...
  glm: (c) => getGlmUsage(c.apiKey, c.provider, c.proxyOptions, c.providerSpecificData, { force: c.force }),
  "glm-cn": (c) => getGlmUsage(c.apiKey, c.provider, c.proxyOptions, c.providerSpecificData, { force: c.force }),
